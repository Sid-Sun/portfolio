              ...
              <Container className="text-center align-content-center">
                <Row>
                  <Col lg className="order-lg-2 mb-3 mt-0">
                    <img
                      src="https://avatars0.githubusercontent.com/u/22845347?s=460&v=4"
                      className="rounded-circle w-lg-75 w-sm-75 img-fluid"
                      width="auto"
                      height="auto"
                      alt="Sid Sun"
                    />
                  ...
                  <Col lg className="mt-md-4 order-lg-1">
                    <div className="container text-lg-left text-md-center">
                      ...
                      <span className="form-row justify-content-center justify-content-lg-start social-icon-group">
                        <a
                          href="https://github.com/sid-sun"
                          className="nav-link pl-lg-1"
                        >
                          <i className="fab fa-github md-24 social-icon" />
                        </a>
                        <a
                          href="https://www.linkedin.com/in/sidharth-soni-3a47b0164"
                          className="nav-link"
                        >
                          <i className="fab fa-linkedin md-24 social-icon" />
                        </a>
                        <a
                          href="https://medium.sidsun.com/"
                          className="nav-link"
                        >
                      ...
                      <p className="lead mb-2">{intro.roles}</p>
