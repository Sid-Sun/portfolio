                ...
                <div className="tableView text-black-75 py-1">
                    <Container className="align-content-center">
                        <div>
                            ...
                            <p className="lead">
                                Your privacy is important to us so we’ve developed a Privacy Policy that covers how we
                            ...
                            <p className="lead">
                                ...
                                traffic.
                                We also use CloudFlare for content delivery network services, DDoS mitigation, Internet
                                security services and as a reverse proxy. <br/> These third-parties have separate and
                                independent
                            ...
                            <p className="lead">According to CalOPPA, we agree to the following. <br/>
                                ...
                                significant
                                page after entering our website.<br/>Our Privacy Policy link includes the word 'Privacy'
                                and
                            ...
                            <p className="lead">
                                If we decide to change our privacy policy, we will post those changes on this page, and
                            ...
                            <p className="lead">
                                If there are any questions, feedback or suggestion regarding this privacy policy and our
